...
class RkDd:
    ...
    def dowork(self, idx: str):
        ...
        editelm = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.CLASS_NAME, "box-title"))
        )
        ...
        relitem = WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.ID, "religion_code_fk"))
        )
        relitem.click()
        dropdown = Select(self.driver.find_element(By.ID, "religion_code_fk"))
        dropdown.select_by_value("0")

        aadhar = self.driver.find_element(By.ID, "aadhaar_number")
        if len(aadhar.get_attribute("value")) > 0:
            aadhar.send_keys(Keys.CONTROL, "a")
            aadhar.send_keys(Keys.CONTROL, "x")
        ...
        elms = WebDriverWait(self.driver, 1).until(
            EC.presence_of_element_located((By.ID, "prev_class_marks_percent"))
        )
        ...
        dropdown = Select(
            self.driver.find_element(By.ID, "free_transport_facility_y_n")
        )
        dropdown.select_by_value("2")
        ...
        dropdown = Select(
            self.driver.find_element(By.ID, "complete_set_of_free_books_y_n")
        )
        dropdown.select_by_value("1")
        ...
        dropdown = Select(
            self.driver.find_element(By.ID, "central_scholarship_rcv_y_n")
        )
        ...
        dropdown = Select(
            self.driver.find_element(By.ID, "extracurricular_activity_involved_y_n")
        )
        dropdown.select_by_value("2")

        dropdown = Select(
            self.driver.find_element(By.NAME, "participated_in_nurturance_camps_y_n")
        )
        dropdown.select_by_value("2")
        ...
        dropdown = Select(
            self.driver.find_element(By.NAME, "free_education_as_per_rte_act_y_n")
        )
        dropdown.select_by_value("1")
        ...
        dropdown = Select(
            self.driver.find_element(By.ID, "special_training_facility_y_n")
        )
        dropdown.select_by_value("2")

        self.driver.find_element(By.ID, "exposure_vocational_activities_y_n").click()
        dropdown = Select(
            self.driver.find_element(By.ID, "exposure_vocational_activities_y_n")
        )
        dropdown.select_by_value("2")

        self.driver.find_element(By.ID, "undertake_vocational_course_y_n").click()
        dropdown = Select(
            self.driver.find_element(By.ID, "undertake_vocational_course_y_n")
        )
        dropdown.select_by_value("2")
